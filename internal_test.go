...
/*
This test file is part of the dnrutil package rather than than the
dnrutil_test package so it can bridge access to the internals to properly test
...
// P2PKH and P2SH denarius addresses.
...
// bech32 encoded P2WPKH and P2WSH denarius addresses.
