...
// Block defines a denarius block that provides easier and more efficient
...
// Tx returns a wrapped transaction (dnrutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (dnrutil.Tx) for all
...
// instead provides easy access to wrapped versions (dnrutil.Tx) of them.
...
// NewBlock returns a new instance of a denarius block given an underlying
...
// NewBlockFromBytes returns a new instance of a denarius block given the
...
// NewBlockFromReader returns a new instance of a denarius block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a denarius block given
