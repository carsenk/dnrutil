...
//   https://github.com/carsenk/bips/blob/master/bip-0032.mediawiki
...
import (
	...
	"github.com/carsenk/dnrd/btcec"
	"github.com/carsenk/dnrd/chaincfg"
	"github.com/carsenk/dnrd/chaincfg/chainhash"
	"github.com/carsenk/dnrutil"
	"github.com/carsenk/dnrutil/base58"
)
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := dnrutil.Hash160(k.pubKeyBytes())[:4]
...
// Address converts the extended key to a standard denarius pay-to-pubkey-hash
// address for the passed network.
func (k *ExtendedKey) Address(net *chaincfg.Params) (*dnrutil.AddressPubKeyHash, error) {
	pkHash := dnrutil.Hash160(k.pubKeyBytes())
	return dnrutil.NewAddressPubKeyHash(pkHash, net)
}
