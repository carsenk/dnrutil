...
A Block defines a denarius block that provides easier and more efficient
...
A Tx defines a denarius transaction that provides more efficient manipulation of
...
To decode/encode an address:
	...
	addr, err := dnrutil.DecodeAddress(addrString, defaultNet)
	if err != nil {
		fmt.Println(err)
		return
	}
