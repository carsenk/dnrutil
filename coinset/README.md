...
(http://godoc.org/github.com/carsenk/dnrutil/coinset)

Package coinset provides denarius-specific convenience functions for selecting
...
```bash
$ go get -u github.com/carsenk/dnrutil/coinset
```
...
The typical use case for this library is for creating raw denarius transactions
