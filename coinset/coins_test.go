...
import (
	...
	"github.com/carsenk/dnrutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    dnrutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() dnrutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value dnrutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = dnrutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = dnrutil.NewTxFromBytes(testSimpleCoinTxBytes)
